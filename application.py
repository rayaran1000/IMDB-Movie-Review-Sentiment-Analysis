...
def predict_datapoint():
    if request.method == 'GET':
        return render_template('home.html',results_1=[], results_2=[], results_3=[], movie_name="", results_df=pd.DataFrame()) # Home.html will contain fields for getting out Input fields
    else:
